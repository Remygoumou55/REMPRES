...
export type FinanceVisualHeatmapCell = {
  day: string;
  value: number;
};

export type FinanceVisualFinalizationModel = {
  ...
  heatmap: FinanceVisualHeatmapCell[];
};

export function buildFinanceVisualFinalizationModel(payload: DeptKpiPayload): FinanceVisualFinalizationModel {

...
export function CrmActivityCreatePanel() {
  ...
  return (
      ...
      onSubmit={(e) => {
        ...
        startTransition(async () => {
          const res = await createCrmActivityAction({
            ...
            relatedKind: String(fd.get("relatedKind")) as
              | "lead"
              | "opportunity"
              | "client"
              | "quote"
    ...
    >
      <p className="sm:col-span-2 text-sm font-medium text-emerald-900">Nouvelle activité / relance</p>
      <select
        name="relatedKind"
        defaultValue="lead"
      ...
      <input
        name="relatedId"
        required
        placeholder="ID entité liée (UUID)"

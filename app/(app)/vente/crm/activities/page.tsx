...
import { CrmActivityCreatePanel } from "@/modules/crm/components/workflows/CrmActivityCreatePanel";
import { CrmActivityCompleteButton } from "@/modules/crm/components/workflows/CrmActivityCompleteButton";
  ...
  return (
    <div className="page-wrapper space-y-6">
      <PageHeader
        ...
        subtitle="Relances, appels et tâches — création gouvernée et clôture avec trace bus."
      />
      <CrmActivityCreatePanel />
            ...
            <tbody>
              {rows.map((r) => (
                <tr key={r.id} className="border-b border-gray-100 hover:bg-gray-50/80">
                  ...
                  <td className="max-w-[320px] truncate px-3 py-2.5 font-medium text-darktext">
                    {r.subject}
                  </td>
                  ...
                  <td className="px-3 py-2.5">
                    <CrmActivityCompleteButton activityId={r.id} />
                  </td>
                </tr>
              ))}
            </tbody>

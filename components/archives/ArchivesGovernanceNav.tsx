...
import { ARCHIVES_GOVERNANCE_NAV, archivesNavActiveId } from "@/lib/archives/governance-nav";

export function ArchivesGovernanceNav() {
  const pathname = usePathname() || "";
  const search = useSearchParams();
  const active = archivesNavActiveId(pathname, search);

  return (
    <nav
      aria-label="Module Archives — gouvernance"

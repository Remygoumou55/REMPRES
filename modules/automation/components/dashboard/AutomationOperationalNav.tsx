...
export function AutomationOperationalNav() {
  const pathname = usePathname();
  const hub = "/admin/automation";

  return (
    <nav className="flex flex-wrap gap-2 border-b border-gray-200 pb-4" aria-label="Navigation automation">

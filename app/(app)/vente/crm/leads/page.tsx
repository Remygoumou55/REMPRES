...
import { CrmLeadCreateForm } from "@/modules/crm/components/workflows/CrmLeadCreateForm";
import { CrmLeadRowActions } from "@/modules/crm/components/workflows/CrmLeadRowActions";
              ...
              {rows.map((r) => (
                <tr key={r.id} className="border-b border-gray-100 hover:bg-gray-50/80">
                  ...
                  <td className="px-3 py-2.5">
                    <CrmLeadRowActions
                      leadId={r.id}
                      currentStatus={r.status as CrmLeadStatus}
                      hasCompany={Boolean(r.company_name?.trim())}
                    />
                  </td>
                </tr>
              ))}
